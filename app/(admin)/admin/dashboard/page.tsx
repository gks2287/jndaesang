    ...
    <div className="flex flex-col h-full overflow-hidden">
      ...
      <div className="bg-white border-b border-gray-200 px-8 h-[65px] flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link href="/admin/companies/new" className="flex items-center gap-2 bg-[#55A4DA] hover:bg-[#3A8BC4] text-white text-[15px] font-semibold px-4 py-2 rounded-lg transition-colors">
