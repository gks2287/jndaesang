...
const MOCK_GENERATED_CONTENT_1: import('@/components/newsletter/NewsletterRender').SavedNewsletterContent = {
  rounds: [
    {
      vol: 1,
      ...
      generated: {
        ...
        intro: '안녕하세요. 오늘은 여러분이 가장 자주 듣는 말 중 하나인 "시키는 대로 하면 되지"라는 표현에서 출발해볼게요. 리더로서 빠른 결정과 명확한 지시는 분명한 강점입니다. 하지만 팀원들이 그 지시를 따르되 마음으로 동참하지 않는다면, 그 성과는 얼마나 지속될 수 있을까요?',
        sections: [
          {
    ...
    },
    {
      ...
      generated: {
        ...
        intro: '지난 회차에서 의사결정 독점의 대가를 살펴봤습니다. 이번에는 한 발 더 나아가, 팀원의 의견을 듣는 것이 왜 "부드러운 리더십"이 아닌 "더 강한 전략"인지 이야기해볼게요.',
        sections: [
          {
    ...
    },
    {
      ...
      generated: {
        ...
        intro: '지금까지 의사결정 참여와 경청에 대해 살펴봤습니다. 세 번째 주제는 리더십의 핵심 도구 중 하나인 "피드백"입니다. 지적과 피드백은 어떻게 다를까요? 그리고 팀원이 움직이게 만드는 피드백은 어떤 요소를 갖추고 있을까요?',
        sections: [
          {
